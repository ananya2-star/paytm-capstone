...
with open(
    f"{PART3}/advisory_agent.py",
    "w",
    encoding="utf-8"
) as f:
    f.write(advisory_agent_code)

print("Created/Updated: advisory_agent.py")
...
GLOBAL_CONFIG_PARAMS = {
    "investor_id": INVESTOR_PROFILES[0]["investor_id"], # Using a default investor_id for global config
    "llm_mode": advisory_agent.llm_mode(),
...
# If advisory_agent was previously imported, remove it from sys.modules
if 'advisory_agent' in sys.modules:
    del sys.modules['advisory_agent']

# Import advisory_agent, which will now load the fresh file
import advisory_agent

print("MOCK_LLM enabled:", advisory_agent.MOCK_LLM)
print("Current LLM mode:", advisory_agent.llm_mode())